...
$route['register'] = 'home/user/register';
...
$route['best'] = 'home/best';
$route['discount'] = 'home/discount';
$route['edit/(:num)'] = 'home/user/edit/$1';
$route['delete/(:num)'] = 'home/user/delete/$1';
$route['product/(:num)'] = 'home/product/index/$1';
$route['category/(:num)'] = 'home/category/index/$1';
$route['404_override'] = '';
$route['translate_uri_dashes'] = FALSE;
